    ...
    return (
        <div>
            <div className='md:flex justify-center items-center'>
                <div>
                    <h1 className=' text-4xl text-center lg:text-left lg:text-6xl font-bold lg:leading-normal'>One Step <br /> Closer To Your <br /> <span className='text-indigo-400'>Dream Job</span></h1>
